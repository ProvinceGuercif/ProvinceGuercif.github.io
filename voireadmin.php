...
<body class="body">
    ...
    <li><a class="btn1" href="admin.php">Reteurn</a></li>
...
<!--  ------------------------------------------------  -->
	...
	<td></td>
		<td></td>
<td>		
<a href="supprimerlotissement.php?supprimerlotissement=<?php echo $idlotissement; ?>"><img src='images/supprimer.png'  class='icon' /></a>
</td>	
